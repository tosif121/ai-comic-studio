    ...
    >
      <div className="container mx-auto p-6 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex space-x-6 text-gray-400">
          ...
          <a href="mailto:team@nanobanana.ai" className="hover:text-white transition-colors">
      ...
      <div className="border-t border-white/10 py-4 text-center text-xs text-gray-500">
        <p className="flex items-center justify-center gap-1">
          Made with <Heart className="w-4 h-4 text-pink-500 animate-pulse" /> by Nano Banana
        </p>
